...
import { updateCurrentUser } from '../../store/actions/currentUserActions';
...
const SignupForm = props => {
  const [userData, setUserData] = useState(initialStateText);
  ...
  const onSubmitHandler = data => {
    if (isEditing) {
      props.updateCurrentUser(userData.userid, data);
    }
    axios
...
export default connect(mapStateToProps, { updateCurrentUser })(SignupForm);
